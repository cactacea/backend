...
//
//import io.github.cactacea.filhouette.impl.providers.OAuth2ProviderSpec
//
///**
...
//    }
//
//    "fail with UnexpectedResponseException if OAuth2Info can be build because of an unexpected response" in new Context {
//      val wsRequest = mock[MockWSRequest]
//      val wsResponse = mock[MockWSRequest#Response]
//      implicit val req = FakeRequest(GET, "?" + Code + "=my.code")
...
//    }
//
//    "use the overridden API URL" in new Context {
