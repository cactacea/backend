 ...
 */
package io.github.cactacea.filhouette.impl.crypto

import java.security.MessageDigest
import java.util.Base64

import io.github.cactacea.filhouette.api.crypto.Crypter
import io.github.cactacea.filhouette.api.exceptions.CryptoException
import io.github.cactacea.filhouette.impl.crypto.JcaCrypter._
...
object JcaCrypter {
  ...
  val UnderlyingIVBug = "[Filhouette][JcaCrypter] Cannot get IV! There must be a bug in your underlying JCE " +
    "implementation; The AES/CTR/NoPadding transformation should always provide an IV"
  val UnexpectedFormat = "[Filhouette][JcaCrypter] Unexpected format; expected [VERSION]-[ENCRYPTED STRING]"
  val UnknownVersion = "[Filhouette][JcaCrypter] Unknown version: %s"
}
