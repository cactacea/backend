...
class AdvertisementSettingsRepositorySpec extends RepositorySpec {
  ...
  test("find session's setting") {
    ...
    val sessionUser = signUp("AdvertisementSettingsRepositorySpec1", "session user password", "session udid")
  ...
  test("update session's setting") {
    ...
    val sessionUser = signUp("AdvertisementSettingsRepositorySpec2", "session user password", "session udid")
