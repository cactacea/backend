...
class AccountMessagesDAOSpec extends DAOSpec {
  ...
  test("find older") {
    ...
    val result1 = execute(accountMessagesDAO.findOlder(groupId, None, None, Some(3), sessionAccount.id.toSessionId))
    ...
    val result2 = execute(accountMessagesDAO.findOlder(groupId, Some(message3.messageId.value), None, Some(3), sessionAccount.id.toSessionId))
    ...
    val result3 = execute(accountMessagesDAO.findOlder(groupId, Some(message6.messageId.value), None, Some(3), sessionAccount.id.toSessionId))
  ...
  test("find earlier") {
    ...
    val result1 = execute(accountMessagesDAO.findEarlier(groupId, None, None, Some(3), sessionAccount.id.toSessionId))
    assert(result1.size == 3)
    val message1 = result1(0)._2
    val message2 = result1(1)._2
    val message3 = result1(2)._2
    ...
    val result2 = execute(accountMessagesDAO.findEarlier(groupId, Some(message3.messageId.value), None, Some(3), sessionAccount.id.toSessionId))
    assert(result2.size == 3)
    val message4 = result2(0)._2
    val message5 = result2(1)._2
    val message6 = result2(2)._2
    ...
    val result3 = execute(accountMessagesDAO.findEarlier(groupId, Some(message6.messageId.value), None, Some(3), sessionAccount.id.toSessionId))
    assert(result3.size == 2)
    val message7 = result3(0)._2
    val message8 = result3(1)._2
