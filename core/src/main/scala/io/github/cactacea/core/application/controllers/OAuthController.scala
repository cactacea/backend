...
import io.github.cactacea.core.application.requests.auth.{GetAuth, PostAuth}
import io.github.cactacea.core.application.responses.AccessCodeCreated
import io.github.cactacea.core.application.views.SignInView
