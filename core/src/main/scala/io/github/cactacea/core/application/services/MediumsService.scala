...
import io.github.cactacea.core.infrastructure.storages.StorageService
...
class MediumsService @Inject()(db: DatabaseService) {
  ...
  def create(multiParams: Map[String, MultipartItem], sessionId: SessionId): Future[Seq[MediumCreated]] = {
