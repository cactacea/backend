...
object CactaceaError {
  ...
  final object CommentAlreadyLiked              extends BadRequest(40016, "Comment already liked.")
  final object CommentNotLiked                  extends BadRequest(40017, "Comment not liked.")
  final object FeedAlreadyLiked                 extends BadRequest(40018, "Feed already liked.")
  final object FeedNotLiked                     extends BadRequest(40019, "Feed not liked.")
  ...
  final object GroupAlreadyHidden               extends BadRequest(40032, "Group already hidden.")
  final object GroupNotHidden                   extends BadRequest(40033, "Group not hidden.")
