...
object Config extends DurationReader {
  ...
  object db { // scalastyle:ignore
    ...
    object master extends config { // scalastyle:ignore
      ...
      lazy val options = masterDBConfig.options.getOrElse("?useSSL=false&allowPublicKeyRetrieval=true")
    ...
    object slave extends config { // scalastyle:ignore
      ...
      lazy val options = slaveDBConfig.options.getOrElse("?useSSL=false&allowPublicKeyRetrieval=true")
