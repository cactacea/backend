...
trait Encoders {
  ...
  implicit val accountChannelIdDecode: MappedEncoding[AccountChannelId, Long] = MappedEncoding[AccountChannelId, Long] (id => id.onlyValue)
  implicit val accountChannelIdEncode: MappedEncoding[Long, AccountChannelId] = MappedEncoding[Long, AccountChannelId] (long => AccountChannelId(long))
  ...
  implicit val channelAuthorityTypeDecode: MappedEncoding[ChannelAuthorityType, Byte] = MappedEncoding[ChannelAuthorityType, Byte] (enumValue => enumValue.toValue)
  ...
  implicit val channelPrivacyTypeDecode: MappedEncoding[ChannelPrivacyType, Byte] = MappedEncoding[ChannelPrivacyType, Byte] (enumValue => enumValue.toValue)
