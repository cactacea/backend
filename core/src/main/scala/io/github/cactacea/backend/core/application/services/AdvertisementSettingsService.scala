...
import io.github.cactacea.backend.core.domain.models.AdvertisementSetting
import io.github.cactacea.backend.core.domain.repositories.AdvertisementSettingsRepository
