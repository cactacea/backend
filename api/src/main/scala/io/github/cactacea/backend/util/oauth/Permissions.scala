...
final object Permissions {
  ...
  final object feedLikes extends Permission(4, "feedLikes"                   , "to like and unlike feed on a user’s behalf")
  final object comments extends Permission(8, "comments"                     , "to post and delete comments on a user’s behalf")
  final object commentLikes extends Permission(16, "commentLikes"            , "to like and unlike comment on a user’s behalf")
  final object groups extends Permission(32, "groups"                        , "to create and delete groups on a user's behalf")
  final object groupInvitations extends Permission(64, "groupInvitations"    , "to create, delete, accept and reject invitations on a user's behalf")
  final object messages extends Permission(128, "messages"                   , "to post and delete messages on a user's behalf")
  final object followerList extends Permission(256, "followerList"           , "to read the list of followers and followed-by users")
  final object relationships extends Permission(512, "relationships"         , "to follow and unfollow accounts on a user’s behalf")
  final object friendRequests extends Permission(1024, "friendRequests"      , "to create and delete friend request on a user’s behalf")
