...
import io.github.cactacea.core.util.responses.CactaceaErrors.{AccountTerminated, AccountTerminatedType, InvalidAccountNameOrPassword, InvalidAccountNameOrPasswordType}
import io.swagger.models.Swagger

@Singleton
class SessionsController @Inject()(@Flag("api.prefix") apiPrefix: String, s: Swagger) extends BackendController {
