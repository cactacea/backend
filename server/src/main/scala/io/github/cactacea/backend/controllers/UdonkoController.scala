...
class UdonkoController @Inject()(db: DatabaseService) extends Controller {
  ...
  post("/expressions") { request: PostExpression =>
    ...
    val a5 = e.faceAttributes.emotion.anger.getOrElse(0.0f)
    val a6 = e.faceAttributes.emotion.contempt.getOrElse(0.0f)
    val a7 = e.faceAttributes.emotion.disgust.getOrElse(0.0f)
    val a8 = e.faceAttributes.emotion.fear.getOrElse(0.0f)
    val a9 = e.faceAttributes.emotion.happiness.getOrElse(0.0f)
    val a10 = e.faceAttributes.emotion.neutral.getOrElse(0.0f)
    val a11 = e.faceAttributes.emotion.sadness.getOrElse(0.0f)
    val a12 = e.faceAttributes.emotion.surprise.getOrElse(0.0f)
...
case class PostExpression(
                           ...
                           faceAttributes: PostExpressionEmotion
                         )
...
case class PostExpressionEmotion(emotion: PostExpressionScores)
