...
case class GetFollows(
                         ...
                         @ApiModelProperty(value = "Maximum number of follower returned on one result page. By default the value is 20 entries. The page size can never be larger than 50.")
